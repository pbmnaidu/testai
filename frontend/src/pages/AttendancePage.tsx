...
export const AttendancePage: React.FC = () => {
  ...
  return (
    <PortalAuthGate
      requiredRole={['contractor', 'officer']}
      portalTitle="Contractor Daily Attendance & Labor Muster"
      portalSubtitle="Live on-site worker headcount verification and geo-tagged muster roll"
      portalBadge="Contractor Muster"
      portalIcon={Camera}
      accentColor="blue"
    >
      <div className="attendance-page space-y-6 p-4 sm:p-6">
